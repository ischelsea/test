...
<div class="container">
	...
	<div id="left1">
		<img src="image/article2.png" width="500px" height="700px">
	</div>
	<div id="right1">
		<div class="panel panel-info">
    		<div class="panel-heading">
				...
				<div>
					<h5>
						<span>${article.time}</span> <a href="/memokey/SortServlet?get=${article.sort}">${article.sort}</a>
					${article.author}
					</h5>
				</div>
				<div class="r_div">
				...
				<c:forEach var="t" items="${article_tags}">
					<a href="/memokey/TagsServlet?get=${t.tag}">标签：${t.tag}&nbsp;</a>
				</c:forEach>
				</div>
